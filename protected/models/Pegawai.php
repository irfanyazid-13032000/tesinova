...
class Pegawai extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama, nomor_pegawai, no_telepon', 'required'),
			array('nama, nomor_pegawai, no_telepon', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_pegawai, nama, nomor_pegawai, no_telepon', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nomor_pegawai',$this->nomor_pegawai,true);
