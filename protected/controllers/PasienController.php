...
class PasienController extends Controller
{
	...
	public function actionChart()
	{
		...
		// $dataProvider = Obat::ambilPasienSudahBayar();
		// $dataProvider->ambilPasienSudahBayar();
		$sudahbayar = count(Pasien::ambilPasienSudahBayar());
		$belumbayar = count(Pasien::ambilPasienBelumBayar());
